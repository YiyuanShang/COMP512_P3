...
public class DistClient implements Watcher, AsyncCallback.StatCallback, AsyncCallback.DataCallback
{
	...
	void startClient() throws IOException//, UnknownHostException, KeeperException, InterruptedException
	{
		...
		taskNodeName = zk.create("/dist40/tasks/task-", dTaskSerial, Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
		//taskNodeName = zk.create("/dist40/tasks/task-", pinfo.getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
